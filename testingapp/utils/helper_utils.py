...
from testingapp.tasks.weather_tasks import fetch_weather_and_cache
...
def newnavbarnavrail(request):
    ...
    return render(request, "testingapp/newnavbar_navrail.html", {"form": form})
...
def post_chart(request):
    return render(request, "testingapp/post_chart.html")
