...
def customer_render_pdf_view(request, feed, pk, *args, **kwargs):
    ...
    css_path = finders.find("testingapp/pdf_recipe.css")
    if css_path:
...
def shopping_list_pdf(request, title, pk, *args, **kwargs):
    ...
    html_content = render_to_string("testingapp/shopping_list.html", {"recipe_object": recipe_object, "recipe_ingredients": recipe_ingredients})
